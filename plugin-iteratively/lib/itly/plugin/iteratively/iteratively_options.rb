...
class Itly
  class Plugin
    ...
    class IterativelyOptions
      attr_reader :url, :disabled, :flush_queue_size, :batch_size, :max_retries, :retry_delay_min,
      ...
      def initialize(
        url:, disabled: nil, flush_queue_size: 10, batch_size: 100, max_retries: 25, retry_delay_min: 10.0,
