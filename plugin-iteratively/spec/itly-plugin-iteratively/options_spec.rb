...
describe Itly::Plugin::Iteratively::Options do
  ...
  it 'constants' do
    expect(Itly::Plugin::Iteratively::Options::DEFAULT_URL).to eq('https://data.us-east-2.iterative.ly/t')
  end
  ...
  describe '#initialize' do
    describe 'default values' do
      ...
      it do
        expect(plugin_options.instance_variable_get('@url')).to eq('https://data.us-east-2.iterative.ly/t')
