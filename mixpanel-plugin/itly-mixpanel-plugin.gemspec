...
require_relative 'lib/itly/mixpanel_plugin'

Gem::Specification.new do |spec|
  spec.name          = 'itly-mixpanel-plugin'
  spec.version       = Itly::MixpanelPlugin::VERSION
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/iterativelyhq/itly-sdk-ruby/mixpanel-plugin'
