...
require_relative 'lib/itly/amplitude-plugin/version'

Gem::Specification.new do |spec|
  spec.name          = 'itly-amplitude-plugin'
  spec.version       = Itly::AmplitudePlugin::VERSION
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/iterativelyhq/itly-sdk-ruby/amplitude-plugin'
