...
require_relative 'lib/itly/segment_plugin'

Gem::Specification.new do |spec|
  spec.name          = 'itly-segment-plugin'
  spec.version       = Itly::SegmentPlugin::VERSION
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/iterativelyhq/itly-sdk-ruby/segment-plugin'
